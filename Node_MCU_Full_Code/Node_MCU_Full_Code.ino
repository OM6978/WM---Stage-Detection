...
// const char *ssid = "ISHANAIRTEL";
// const char *password = "iotevalplease";
// const char *ssid = "O.M.";
...
void loop()
{
  if (s.available() >= sizeof(char))
  {
    ...
    while(s.available() > 0)
    {
      ...
      else if(count == 3 && whichchannel == 1)stage1 = (int)receiveddata - 48;
      else if(count == 3 && whichchannel == 2)stage2 = (int)receiveddata - 48;
      else
      {
...
void Sendreading()
{
  ...
  ThingSpeak.setField(1,stage1);
  ThingSpeak.setField(3,stage2);
